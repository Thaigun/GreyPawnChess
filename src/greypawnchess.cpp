...
Napi::String Greetings(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	return Napi::String::New(env, "Gray pawns chess engine");
}
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
	...
	// ...
	exports.Set(Napi::String::New(env, "greetings"), Napi::Function::New(env, Greetings));
